...
router.put('/buy/:id', auth, async (req, res) => {
    ...
    const mailOptions = {
        ...
        html: `<h4 style="font-size:30px;color:red;font-weight:bold;font-family:fantasy;font-style:italic; text-align:center">Item Details</h4>
               <span style="font-style:italic;font-weight:bold; text-align:center">
                   <form>
                    <label for="category">Category:</label>
                    <span style="color:violet;font-weight:bold;font-family:fantasy;font-style:italic" id="category">${category}</span>
                    <br/>
                    <label for="name">Product Name:</label>
                    <span style="color:violet;font-weight:bold;font-family:fantasy;font-style:italic" id="name">${productName}</span>
                    <br/>
                    <label for="price">Price:</label>
                    <span style="color:violet;font-weight:bold;font-family:fantasy;font-style:italic" id="price">${formatter.format(price)}</span> 
                    <br/>
                    <label for="quantity">Quantity:</label>
                    <span style="color:violet;font-weight:bold;font-family:fantasy;font-style:italic" id="quantity">${quantity}</span>
                   </form> 
               </span>
              `
    }
